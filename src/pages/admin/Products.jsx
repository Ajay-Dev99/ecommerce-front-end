    ...
    return (
        <div className='space-y-6'>
            ...
            <div className='flex flex-col md:flex-row justify-between'>
                <button onClick={() => navigate("addproduct")} className='bg-green-500 p-1 text-md  md:p-2 text-white rounded-md'>Add New Product</button>
                ...
                <div className="relative mt-1 w-full md:w-80">
                    ...
                    <input type="text" id="table-search" className="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" />
                </div>
            </div>
            {/* table */}
            ...
            <div className='flex justify-between'>
                ...
                <button className='btn bg-red-600 text-white py-1 rounded-sm px-3'>Delete</button>
            </div>
